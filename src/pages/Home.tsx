...
interface IHomeProps {
  authModal?: 'login' | 'register' | 'recover';
}

const Home = ({ authModal }: IHomeProps) => {
  ...
  return (
    <>
            ...
            <div className="flex flex-col lg:flex-row items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-8">
                  FleteShare conecta clientes y transportistas de manera eficiente, reduciendo
                  costos y optimizando rutas para un servicio de fletes más económico y ecológico.
                </p>
            ...
            >
              ...
              <motion.div variants={fadeIn} className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Desde pequeños paquetes hasta muebles grandes, encuentra el transporte ideal
                    para cada envío.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  "Como transportista, FleteShare me permitió organizar mejor mis rutas y aumentar
                  mis ingresos. La plataforma es intuitiva y los pagos son puntuales."
                </p>
              </motion.div>
            </motion.div>
          </div>
      ...
      {/* Auth Modal */}
      {authModal && <AuthModal type={authModal} onClose={handleCloseModal} />}
    </>
  );
};
